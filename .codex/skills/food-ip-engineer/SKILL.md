...
Food-IP 是餐饮老板的 AI 内容编导。最终目标是让内容从真实素材出发，经过判断、创作和诊断，达到可拍摄交付状态。
...
- 涉及架构或 Workflow 边界、Schema / API / 数据契约、事实语义、存储 / Retrieval、模型 / provider、重大依赖、路线 / 成本或验收标准时：先检查现状，说明选项、权衡和建议，等待用户确认。
